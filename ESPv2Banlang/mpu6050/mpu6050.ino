...
#define SWAP(x,y) swap = x; x = y; y = swap
    ...
    short accData[3];
    short gyrData[3];
    accData[0] = accel_t_gyro.value.x_accel;
    accData[1] = accel_t_gyro.value.y_accel;
    accData[2] = accel_t_gyro.value.z_accel;
    gyrData[0] = accel_t_gyro.value.x_gyro;
    gyrData[1] = accel_t_gyro.value.y_gyro;
    gyrData[2] = accel_t_gyro.value.z_gyro;
